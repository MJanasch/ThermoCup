...
% load('ThermoCup_InputDataforScores_Frc.mat');
% load('ThermoCup_InputDataforScores_Suc.mat');
load('ThermoCup_InputDataforScores_For.mat');
...
% Be aware that for formate there are no EFMs indcluded that use AclAB
