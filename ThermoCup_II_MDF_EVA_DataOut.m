...
for i = 1:length(mnet.efms)
    if mnet.efms(9,i) ~= 0 && ((mnet.efms(AclAB,i) == 0 && mnet.efms(Xfpk1,i) == 0 && mnet.efms(Xfpk2,i) == 0) || ... % WT
            (mnet.efms(AclAB,i) ~= 0 && mnet.efms(Xfpk1,i) == 0 && mnet.efms(Xfpk2,i) == 0) || ...   % aclAB
            (mnet.efms(AclAB,i) == 0 && ...
            ((mnet.efms(Xfpk1,i) ~= 0 && mnet.efms(Xfpk2,i) ~= 0) ||...
            (mnet.efms(Xfpk1,i) ~= 0 && mnet.efms(Xfpk2,i) == 0) || ...
            (mnet.efms(Xfpk1,i) == 0 && mnet.efms(Xfpk2,i) ~= 0))))
        r=r+1;
        Result(i) = 1;
